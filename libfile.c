...
{
    file fd;
    fd = open(path, O_RDONLY | O_CREAT, S_IRWXU |  S_IRWXG | S_IROTH);
    return (fd);
}
...
{
    file fd;
    fd = open(path, O_WRONLY | O_CREAT, S_IRWXU |  S_IRWXG | S_IROTH);
    return (fd);
}
...
{
    file fd;
    fd = open(path, O_RDWR | O_CREAT, S_IRWXU |  S_IRWXG | S_IROTH);
    return (fd);
}
